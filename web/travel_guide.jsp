...
<html>
    <head>
        <title>The Travler Website Template | Travel Guide :: w3layouts</title>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
        <link href="Assets/css/style.css" rel="stylesheet" type="text/css" media="all" />
        <link rel="stylesheet" href="Assets/css/jquery-ui.css" />
        <!-- start reservation form -->
        <link type="text/css" rel="stylesheet" href="Assets/css/JFform.css" />
            ...
            <div class="wrap">
                ...
                <div class="header_menu">
                    <div class="menu_box_list">
                        <ul>
                            <li class="color1 active"><a href="travel_guide.jsp"><i class="icon1"> </i><span>travel guide</span></a></li>
                            <li class="color2"><a href="service.jsp"> <i class="icon2"> </i> <span>Service</span></a></li>
                            ...
                            <li class="color5"><a href="travel_guide.jsp"> <i class="icon5"> </i> <span>how to</span></a></li>
                    ...
                    <div class="res-form">
                        <div class="reservation">
                            <div class="row">
                                ...
                                <div class="col col-4">
                                    <label class="radio"><input type="radio" name="radio"><i></i>Multi City</label>
                                </div>
                                <div class="clear"></div>
                            </div>
                            <div class="reservation_form">	
                                <form>
                                    ...
                                    <input type="text"  name="text" placeholder="to" /> 
                                </form>
                            </div>
                            <!---strat-date-piker---->
            ...
            $(function () {
                $("#datepicker").datepicker();
                            ...
                            <div class="reservation_date">  
                                <form>
                                    <input class="text-box-light "  type="text" id="datepicker" value="Join Date" onfocus="this.value = '';" onblur="if (this.value == '') {
                                                this.value = 'Join Date';
                                            }"><em class="pay-date"> </em></h2>
                                    <input type="submit"  name="text" value="search"/> 
                                </form>
                            </div>
                        </div>	
                    </div>
