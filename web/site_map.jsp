...
<html>
    <head>
        <title>The Travler Website Template | Sitemap :: w3layouts</title>
                ...
                <div class="header_menu">
                    <div class="menu_box_list">
                        <ul>
                            ...
                            <li class="color3 active"><a href="about.jsp"> <i class="icon3"> </i><span>about</span></a></li>
            ...
            <div class="wrap">
                <div class="content">
                    <div class="content_text about">
                        <h2>The best travler guide sitemap </h2>
